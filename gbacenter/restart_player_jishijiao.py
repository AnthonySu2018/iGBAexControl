...
messages = [] #接收日志信息
li_locate_ip = [['欢迎大屏', '192.168.58.32'], ['AI赋能百业', '192.168.58.33'], ['产品体验1', '192.168.58.34'],
                ['产品体验2', '192.168.58.35'], ['生态赋能1', '192.168.58.36'], ['生态赋能2', '192.168.58.37'],
                ['AI大屏', '192.168.58.38']]
...
def creat_button_log(root):
    ...
    log_text.insert(tk.END, f"请对应左边的区域重启播放盒，可以先重启，看看是否是目标播放盒。")
    ...
    for i, button_name in enumerate(button_names):
        ...
        button.grid(row=row, column=column, padx=30, pady=3, sticky="nsew")
    return log_text
